...
<body>
  <div class="container">
    <div class="conteudo">
      ...
      <hr>
      <p>Nosso consultor entrará em contato com você o mais rápido possível!</p>
      <p>Caso prefira falar pelo WhatsApp clique no botão abaixo para enviar uma mensagem</p>
      <div class="icones">
        <ul>
          <?php
          $franqueado = $_GET['f'];
          ...
          $landingpage = $_GET['l'];
          ?>
          <a href="whatsapp.php?f=<?=$franqueado?>&u=<?=$unidade?>=&l=<?=$landingpage?>" target="_blank"><li>WhatsApp</li></a>
        </ul>
      </div>
    </div>
  </div>
