...
if(isset($_POST['deletar'])){
    ...
    $excluir = crud('excluir','produto', '', $sucesso, $falha, $id);
    echo $excluir;
}
?>
<div class="jumbotron text-center padding-0">
    <h3>Curso</h3>
    <p>Exclusão do Curso</p>
</div>
<div class="container">
    <hr>
    <form action="./?modulo=produto&acao=excluir&id=<?=$id?>" method="POST">
        <input type="hidden" name="deletar" value="sim">
        <input type="hidden" name="id" value="<?=$id?>">
        <div class="alert alert-warning fade show" role="alert">
            <strong>Deseja excluir o curso '<?=$produto['nome']?>'?</strong><br>
        ...
        <div class="text-center">
            ...
            <a href="./?modulo=produto&acao=listar" class="btn btn-default btn-lg"><i class="fa fa-angle-double-left"></i> Cancelar</a>
        </div>
</form>
</div>