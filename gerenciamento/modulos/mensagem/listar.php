<div class="jumbotron text-center padding-0">
	<h3>Mensagens</h3>
	<p>Mensagens enviadas e recebidas</p>
</div>
<!-- <div class="container">
	<ul class="list-inline">
		<li class="list-inline-item"><a href="./?modulo=servico&acao=cadastrar"><i class="fa fa-plus"></i> Adicionar contato<a></li>
		</ul>
	</div> -->
	<form>
		<div class="form-row align-items-center mb-3">
			<!-- <div class="col-12 col-md-2 mb-2">
				<a class="btn btn-outline-primary" href="./?modulo=mensagem&acao=cadastrar"><i class="fa fa-plus"></i> Enviar nova mensagem</a>
			</div> -->
			<!-- <div class="col-5 col-md-2">
				<select name="campo-filtro" id="campo-filtro" class="form-control">
			...
			<div class="col-5 col-md-3">
				<input type="text" class="form-control" name="valor-filtro">
			</div>
	...
	<div class="container">
		<hr>
		<h5 class="mb-3"># Mensagens enviadas</h5>
		<div class="row">
			<div class="table-responsive">
				<table class="table table-hover md-12 text-center">
					...
					<tbody>
						...
						$mensagens = $conexao->prepare($query);
						$mensagens->execute();
						while($mensagem = $mensagens->fetch(PDO::FETCH_ASSOC)){
							?>
							<tr>
								<th scope="row"><?=date_format(date_create($mensagem['data']), 'd/m/Y')?></th>
								<td><?=$mensagem['contato']?></td>
					...
					<div class="modal-content text-center">
						...
						<div class="modal-body">
							<form id="form-email" method="post">
								<input type="text" name="destinatario" id="destinatario-email">
								<input type="text" name="remetente" id="remetente-email" value="<?=$cliente['nome']?>">
								<input type="text" name="nome" id="nome-email">
								<input type="text" name="contato" id="contato-email">
								<input type="text" name="data" id="data-email" value="<?=date('Y-m-d H:i:s')?>">
								<div class="form-row">
