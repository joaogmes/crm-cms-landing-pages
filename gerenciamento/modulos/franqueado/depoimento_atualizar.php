...
if($id==''){
    die("<script>window.location.href='./?pagina==depoimentos';</script>");
}
...
<div class="container">
	<hr>
	<form method="POST" action="./?pagina=depoimento_atualizar&acao=atualizar&id=<?=$id?>" enctype="multipart/form-data">
